...
// Liste des pays avec codes téléphoniques (Afrique en premier, puis autres)
const countries = [
  // Côte d'Ivoire en premier (par défaut)
  ...
  { code: '+220', name: 'GM', flag: '🇬🇲', fullName: 'Gambie' },
  { code: '+231', name: 'LR', flag: '🇱🇷', fullName: 'Liberia' },
  { code: '+232', name: 'SL', flag: '🇸🇱', fullName: 'Sierra Leone' },
  { code: '+233', name: 'GH', flag: '🇬🇭', fullName: 'Ghana' },
  { code: '+234', name: 'NG', flag: '🇳🇬', fullName: 'Nigeria' },
  { code: '+235', name: 'TD', flag: '🇹🇩', fullName: 'Tchad' },
  { code: '+237', name: 'CM', flag: '🇨🇲', fullName: 'Cameroun' },
  { code: '+238', name: 'CV', flag: '🇨🇻', fullName: 'Cap-Vert' },
  { code: '+239', name: 'ST', flag: '🇸🇹', fullName: 'Sao Tomé-et-Príncipe' },
  { code: '+240', name: 'GQ', flag: '🇬🇶', fullName: 'Guinée équatoriale' },
  { code: '+241', name: 'GA', flag: '🇬🇦', fullName: 'Gabon' },
  { code: '+242', name: 'CG', flag: '🇨🇬', fullName: 'Congo' },
  { code: '+243', name: 'CD', flag: '🇨🇩', fullName: 'RD Congo' },
  { code: '+244', name: 'AO', flag: '🇦🇴', fullName: 'Angola' },
  // Afrique du Nord
  { code: '+212', name: 'MA', flag: '🇲🇦', fullName: 'Maroc' },
  { code: '+213', name: 'DZ', flag: '🇩🇿', fullName: 'Algérie' },
  { code: '+216', name: 'TN', flag: '🇹🇳', fullName: 'Tunisie' },
  { code: '+218', name: 'LY', flag: '🇱🇾', fullName: 'Libye' },
  { code: '+20', name: 'EG', flag: '🇪🇬', fullName: 'Égypte' },
  // Afrique de l'Est
  { code: '+249', name: 'SD', flag: '🇸🇩', fullName: 'Soudan' },
  { code: '+250', name: 'RW', flag: '🇷🇼', fullName: 'Rwanda' },
  { code: '+251', name: 'ET', flag: '🇪🇹', fullName: 'Éthiopie' },
  { code: '+252', name: 'SO', flag: '🇸🇴', fullName: 'Somalie' },
  { code: '+253', name: 'DJ', flag: '🇩🇯', fullName: 'Djibouti' },
  { code: '+254', name: 'KE', flag: '🇰🇪', fullName: 'Kenya' },
  { code: '+255', name: 'TZ', flag: '🇹🇿', fullName: 'Tanzanie' },
  { code: '+256', name: 'UG', flag: '🇺🇬', fullName: 'Ouganda' },
  { code: '+257', name: 'BI', flag: '🇧🇮', fullName: 'Burundi' },
  { code: '+258', name: 'MZ', flag: '🇲🇿', fullName: 'Mozambique' },
  { code: '+260', name: 'ZM', flag: '🇿🇲', fullName: 'Zambie' },
  { code: '+261', name: 'MG', flag: '🇲🇬', fullName: 'Madagascar' },
  { code: '+262', name: 'RE', flag: '🇷🇪', fullName: 'La Réunion' },
  { code: '+269', name: 'KM', flag: '🇰🇲', fullName: 'Comores' },
  { code: '+290', name: 'SH', flag: '🇸🇭', fullName: 'Sainte-Hélène' },
  { code: '+291', name: 'ER', flag: '🇪🇷', fullName: 'Érythrée' },
  { code: '+297', name: 'AW', flag: '🇦🇼', fullName: 'Aruba' },
  // Afrique australe
  { code: '+263', name: 'ZW', flag: '🇿🇼', fullName: 'Zimbabwe' },
  { code: '+264', name: 'NA', flag: '🇳🇦', fullName: 'Namibie' },
  { code: '+265', name: 'MW', flag: '🇲🇼', fullName: 'Malawi' },
  { code: '+266', name: 'LS', flag: '🇱🇸', fullName: 'Lesotho' },
  { code: '+267', name: 'BW', flag: '🇧🇼', fullName: 'Botswana' },
  { code: '+268', name: 'SZ', flag: '🇸🇿', fullName: 'Eswatini' },
  { code: '+27', name: 'ZA', flag: '🇿🇦', fullName: 'Afrique du Sud' },
  { code: '+262', name: 'YT', flag: '🇾🇹', fullName: 'Mayotte' },
  // Europe
  { code: '+33', name: 'FR', flag: '🇫🇷', fullName: 'France' },
  { code: '+32', name: 'BE', flag: '🇧🇪', fullName: 'Belgique' },
  { code: '+41', name: 'CH', flag: '🇨🇭', fullName: 'Suisse' },
  { code: '+352', name: 'LU', flag: '🇱🇺', fullName: 'Luxembourg' },
  { code: '+49', name: 'DE', flag: '🇩🇪', fullName: 'Allemagne' },
  { code: '+44', name: 'GB', flag: '🇬🇧', fullName: 'Royaume-Uni' },
  { code: '+39', name: 'IT', flag: '🇮🇹', fullName: 'Italie' },
  { code: '+34', name: 'ES', flag: '🇪🇸', fullName: 'Espagne' },
  { code: '+351', name: 'PT', flag: '🇵🇹', fullName: 'Portugal' },
  { code: '+31', name: 'NL', flag: '🇳🇱', fullName: 'Pays-Bas' },
  { code: '+43', name: 'AT', flag: '🇦🇹', fullName: 'Autriche' },
  { code: '+48', name: 'PL', flag: '🇵🇱', fullName: 'Pologne' },
  { code: '+7', name: 'RU', flag: '🇷🇺', fullName: 'Russie' },
  { code: '+30', name: 'GR', flag: '🇬🇷', fullName: 'Grèce' },
  { code: '+46', name: 'SE', flag: '🇸🇪', fullName: 'Suède' },
  { code: '+47', name: 'NO', flag: '🇳🇴', fullName: 'Norvège' },
  { code: '+45', name: 'DK', flag: '🇩🇰', fullName: 'Danemark' },
  { code: '+358', name: 'FI', flag: '🇫🇮', fullName: 'Finlande' },
  { code: '+353', name: 'IE', flag: '🇮🇪', fullName: 'Irlande' },
  { code: '+90', name: 'TR', flag: '🇹🇷', fullName: 'Turquie' },
  { code: '+380', name: 'UA', flag: '🇺🇦', fullName: 'Ukraine' },
  { code: '+40', name: 'RO', flag: '🇷🇴', fullName: 'Roumanie' },
  { code: '+36', name: 'HU', flag: '🇭🇺', fullName: 'Hongrie' },
  { code: '+420', name: 'CZ', flag: '🇨🇿', fullName: 'Rép. tchèque' },
  { code: '+421', name: 'SK', flag: '🇸🇰', fullName: 'Slovaquie' },
  // Amériques
  { code: '+1', name: 'US', flag: '🇺🇸', fullName: 'États-Unis' },
  { code: '+1', name: 'CA', flag: '🇨🇦', fullName: 'Canada' },
  { code: '+52', name: 'MX', flag: '🇲🇽', fullName: 'Mexique' },
  { code: '+55', name: 'BR', flag: '🇧🇷', fullName: 'Brésil' },
  { code: '+54', name: 'AR', flag: '🇦🇷', fullName: 'Argentine' },
  { code: '+56', name: 'CL', flag: '🇨🇱', fullName: 'Chili' },
  { code: '+57', name: 'CO', flag: '🇨🇴', fullName: 'Colombie' },
  { code: '+51', name: 'PE', flag: '🇵🇪', fullName: 'Pérou' },
  { code: '+58', name: 'VE', flag: '🇻🇪', fullName: 'Venezuela' },
  { code: '+593', name: 'EC', flag: '🇪🇨', fullName: 'Équateur' },
  { code: '+595', name: 'PY', flag: '🇵🇾', fullName: 'Paraguay' },
  { code: '+598', name: 'UY', flag: '🇺🇾', fullName: 'Uruguay' },
  { code: '+509', name: 'HT', flag: '🇭🇹', fullName: 'Haïti' },
  { code: '+53', name: 'CU', flag: '🇨🇺', fullName: 'Cuba' },
  { code: '+1', name: 'DO', flag: '🇩🇴', fullName: 'Rép. dominicaine' },
  // Asie
  { code: '+86', name: 'CN', flag: '🇨🇳', fullName: 'Chine' },
  { code: '+91', name: 'IN', flag: '🇮🇳', fullName: 'Inde' },
  { code: '+81', name: 'JP', flag: '🇯🇵', fullName: 'Japon' },
  { code: '+82', name: 'KR', flag: '🇰🇷', fullName: 'Corée du Sud' },
  { code: '+65', name: 'SG', flag: '🇸🇬', fullName: 'Singapour' },
  { code: '+60', name: 'MY', flag: '🇲🇾', fullName: 'Malaisie' },
  { code: '+66', name: 'TH', flag: '🇹🇭', fullName: 'Thaïlande' },
  { code: '+84', name: 'VN', flag: '🇻🇳', fullName: 'Viêt Nam' },
  { code: '+62', name: 'ID', flag: '🇮🇩', fullName: 'Indonésie' },
  { code: '+63', name: 'PH', flag: '🇵🇭', fullName: 'Philippines' },
  { code: '+92', name: 'PK', flag: '🇵🇰', fullName: 'Pakistan' },
  { code: '+880', name: 'BD', flag: '🇧🇩', fullName: 'Bangladesh' },
  { code: '+971', name: 'AE', flag: '🇦🇪', fullName: 'Émirats arabes unis' },
  { code: '+966', name: 'SA', flag: '🇸🇦', fullName: 'Arabie saoudite' },
  { code: '+972', name: 'IL', flag: '🇮🇱', fullName: 'Israël' },
  { code: '+961', name: 'LB', flag: '🇱🇧', fullName: 'Liban' },
  { code: '+98', name: 'IR', flag: '🇮🇷', fullName: 'Iran' },
  { code: '+964', name: 'IQ', flag: '🇮🇶', fullName: 'Irak' },
  { code: '+962', name: 'JO', flag: '🇯🇴', fullName: 'Jordanie' },
  { code: '+963', name: 'SY', flag: '🇸🇾', fullName: 'Syrie' },
  // Océanie
  { code: '+61', name: 'AU', flag: '🇦🇺', fullName: 'Australie' },
  { code: '+64', name: 'NZ', flag: '🇳🇿', fullName: 'Nouvelle-Zélande' },
  { code: '+687', name: 'NC', flag: '🇳🇨', fullName: 'Nouvelle-Calédonie' },
  { code: '+689', name: 'PF', flag: '🇵🇫', fullName: 'Polynésie française' }
]
