...
<template>
  <div>
    ...
    <div v-if="vente && vente.lignes" ref="receiptContent" :style="receiptContainerStyle">
...
const props = defineProps({
  vente: {
    type: Object,
    required: true,
    default: () => ({ lignes: [], montant_total: 0, montant_paye: 0 })
  },
  magasinInfo: {
    type: Object,
    required: true,
    default: () => ({ nom: '', adresse: '', telephone: '', email: '' })
  }
})
